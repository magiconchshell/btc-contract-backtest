...
from btc_contract_backtest.live.exchange_adapter import ExchangeExecutionAdapter, AdapterResult
...
class FakeExchangeStateful:
    def __init__(self):
        ...
        self.sandbox = None
        self.calls = []
        self.positions = [{"symbol": "BTCUSDT", "contracts": 0.001, "entryPrice": 45000.0}]
        self.open_orders = [
            {"id": "ex-1", "clientOrderId": "c-1", "status": "open", "side": "buy", "type": "market", "amount": 0.001, "filled": 0.0},
        ]
...
def test_execution_state_dedupes_replayed_events_and_tracks_gap(tmp_path):
    ...
    clock = ClockHarness()
    script = [[
        {"e": "ORDER_TRADE_UPDATE", "E": 1735689600123, "T": 1735689600456, "o": {"i": 101, "c": "c-1", "x": "TRADE", "X": "FILLED", "z": "0.001", "t": 1}},
        {"e": "ORDER_TRADE_UPDATE", "E": 1735689600123, "T": 1735689600456, "o": {"i": 101, "c": "c-1", "x": "TRADE", "X": "FILLED", "z": "0.001", "t": 1}},
        {"e": "ACCOUNT_UPDATE", "E": 1735689601123, "T": 1735689601456, "a": {"m": "ORDER", "B": [], "P": [{"s": "BTCUSDT", "pa": "0.001"}] }},
        {"e": "ORDER_TRADE_UPDATE", "E": 1735689602123, "T": 1735689602456, "o": {"i": 102, "c": "c-1", "x": "TRADE", "X": "FILLED", "z": "0.001", "t": 4}},
    ]]
